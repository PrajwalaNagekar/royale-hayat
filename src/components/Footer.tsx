...
const Footer = () => {
  ...
  const quickLinks = [
    ...
    { labelKey: "ourServices", href: "#services" },
    { labelKey: "findADoctor", href: "#our-doctors" },
    { labelKey: "bookAppointment", href: "/book-appointment", isRoute: true },
    { labelKey: "contactUsFooter", href: "#contact" },
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-3">
              {deptNames.map((d) => (
                <a key={d.en} href="#departments" className="text-primary-foreground/70 font-body text-sm hover:text-accent transition-colors">
                  {lang === "ar" ? d.ar : d.en}
                </a>
              ))}
            </nav>
