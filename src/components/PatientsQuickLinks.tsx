import { Heart, ClipboardList, ShieldCheck, Bed, ScrollText, MapPin, Camera, FileText, Download } from "lucide-react";
...
const PatientsQuickLinks = () => {
  ...
  const links = [
    ...
    { icon: MapPin, label: t("internationalPatient"), href: "/patients-visitors" },
    { icon: Camera, label: t("newbornPhotography"), href: "/patients-visitors" },
    { icon: FileText, label: t("medicalRecordsForm"), href: "/patients-visitors" },
    { icon: Download, label: t("downloads"), href: "/downloads" },
  ];
